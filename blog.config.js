...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'efe2d0722e0243c2b30149f480fb83f3',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个Engineer, Hi，我是Tommy,Hi，我是一个管理人,歡迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Little Tommy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的人,忙於搵食嘅小市民🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lau8hk.dynv6.net', // 网站地址
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'phantom0123pp/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'phantom0123pp', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'phantom0123pp', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个由Tommy用NotionNext生成的站点', // 站点描述，被notion中的页面描述覆盖
